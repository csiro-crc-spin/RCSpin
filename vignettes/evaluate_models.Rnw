...
Adenoma prevalence                                                         &                             &              &         &              &         &              \\
\hspace{4mm} Among individuals 40-49 years old                             & 0.10                        & 0.14         &         & 0.15         &         & 0.15         \\
\hspace{4mm} Among individuals 50-75 years old                             & 0.22                        & 0.27         &         & 0.23         &         & 0.24         \\
\hspace{4mm} Among individuals 76-80 years old                             & 0.29                        & 0.38         &         & 0.31         &         & 0.31         \\
...
\hspace{4mm} Percent of adenomas $ \geq 10 mm  $                           & 0.09                        & 0.17         &         & 0.11         &         & 0.12         \\
                                                                           &                             &              &         &              &         &              \\
...
\hspace{4mm} Rectal cancer in women                                        &                             &              &         &              &         &              \\
...
\hspace{4mm} Colon cancer in men                                           &                             &              &         &              &         &              \\
...
\hspace{4mm} Rectal cancer in men                                          &                             &              &         &              &         &              \\
...
%% \small
%% \begin{center}
%% \begin{tabular}{||p{7cm}|l|l||l|l|l||l|l|l||}
%%   \hline
%%                                                                                              & Observed & Estimated CR & model5.s & crcSpin.R & SpinModels & model3.s & dukesCrcSpin.R \\
%% Adenoma prevalence                                                                           &          &              &          &          &        &          &        \\
%% \hspace{4mm} Among individuals 40-49 years old                                               & 0.10     & 0.14         & 0.16     & 0.15     & 0.16   & 0.10     & 0.15   \\
%% \hspace{4mm} Among individuals 50-75 years old                                               & 0.22     & 0.27         & 0.25     & 0.21     & 0.21   & 0.17     & 0.20   \\
%% \hspace{4mm} Among individuals 76-80 years old                                               & 0.29     & 0.38         & 0.23     & 0.21     & 0.21   & 0.21     & 0.21   \\
%% \hspace{4mm} Number of adenomas found in 1233 individuals                                    & 534      & 575          &          &          &        &          &        \\
%%                                                                                              &          &              &          &          &        &          &        \\
%% Adenoma size                                                                                 &          &              &          &          &        &          &        \\
%% \hspace{4mm} Percent of individuals with an   
...
%% \hspace{4mm} Percent of adenomas $\leq$ 6mm                                                  & 0.62     & 0.61         &          &          &        &          &        \\
%% \hspace{4mm} Percent of adenomas $ [6,10)  mm  $                                             & 0.29     & 0.22         &          &          &        &          &        \\
%% \hspace{4mm} Percent of adenomas $ \geq 10 mm  $                                             & 0.09     & 0.17         & 0.08     & 0.12     &   0.15 & 0.10     & 0.10   \\
%%                                                                                              &          &              &          &          &        &          &        \\
%% Clinical cancers in per 100,000                                                              &          &              &          &          &        &          &        \\
%% \hspace{4mm} Colon cancer in women                                                           &          &              &          &          &        &          &        \\
%% \hspace{8mm}  20-49 y.o.                                                                     & 4.8      & 4.4          & 14       &          &        & 15       &  36    \\
%% \hspace{8mm} 50-59 y.o.                                                                      & 43.3     & 45.5         & 162      &          &        & 36       &  87    \\
%% \hspace{8mm} 60-69 y.o.                                                                      & 100.7    & 99.3         & 331      &          &        & 60       &  113   \\
%% \hspace{8mm} 70-84 y.o.                                                                      & 216.7    & 207.3        & 600      &          &        & 134      &  247   \\
%% \hspace{4mm} Rectal cancer in women                                                          &          &              &          &          &        &          &        \\
%% \hspace{8mm} 20-49 y.o.                                                                      & 1.87     & 2.0          & 4        &          &        & 1        &  2     \\
%% \hspace{8mm} 50-59 y.o.                                                                      & 20.4     & 18.6         & 34       &          &        & 4        &  9     \\
%% \hspace{8mm} 60-69 y.o.                                                                      & 42.5     & 39.7         & 54       &          &        & 7        &  10    \\
%% \hspace{8mm} 70-84 y.o.                                                                      & 73.9     & 82.1         & 86       &          &        & 10       &  29    \\
%% \hspace{4mm} Colon cancer in men                                                             &          &              &          &          &        &          &        \\
%% \hspace{8mm} 20-49 y.o.                                                                      & 4.51     & 4.2          & 13       &          &        & 21       &   33   \\
%% \hspace{8mm} 50-59 y.o.                                                                      & 45.9     & 50.6         & 182      &          &        & 70       &   92   \\
%% \hspace{8mm} 60-69 y.o.                                                                      & 121.4    & 120.0        & 467      &          &        & 118      &   108  \\
%% \hspace{8mm} 70-84 y.o.                                                                      & 268.4    & 263.4        & 810      &          &        & 224      &   236  \\
%% \hspace{4mm} Rectal cancer in men                                                            &          &              &          &          &        &          &        \\
%% \hspace{8mm} 20-49 y.o.                                                                      & 2.3      & 3.2          & 8        &          &        & 2        &  3     \\
%% \hspace{8mm} 50-59 y.o.                                                                      & 30.0     & 29.8         & 44       &          &        & 8        &  6     \\
%% \hspace{8mm} 60-69 y.o.                                                                      & 71.4     & 63.2         & 87       &          &        & 10       &  11    \\
%% \hspace{8mm} 70-84 y.o.                                                                      & 128.0    & 123.8        & 91       &          &        & 26       &  19    \\   
%%                                                                                              &          &              &          &          &        &          &        \\
%% male --CRC between 50th and 70th birthdays                                                   & 0.019    &              & 0.083    & 0.05     &  0.05  & 0.022    & 0.09   \\
%% female --CRC between 50th and 70th birthdays                                                 & 0.014    &              & 0.064    & 0.033    &  0.03  & 0.011    & 0.08   \\           
...
\end{figure}
   ...
   \begin{itemize}
   \item model5.s -- the CRC-Spin model with the CR posterior estimates and no staging -- implemented in S4
   \item crcSpin.R -- the CRC-Spin model with the CR posterior estimates and no staging -- implemented in R5
   \item SpinModels -- the CRC-Spin model with the CR posterior estimates and no staging -- implemented in Rcpp
   \item  model3.s -- the CRC-Spin model with the CR posterior estimates and Dukes staging -- implemented in S4
   \item dukesCrcSpin.R -- the CRC-Spin model with the CR posterior estimates and Dukes staging -- implemented in R5
   \end{itemize}
...
%% \section{Introduction}
%% The CRC-Spin model describes the natural history of colo-rectal
%% cancer. See  \cite{Rutter.2008}, \cite{Rutter.et.al.2009}, \cite{Rutter.and.Savarino.2010},
%% and  \cite{Rutter.et.al.2011}. An individuals path goes through
%% ``adenoma'', ``large adenoma'' and ``pre-clinical CRC'' stages to ``CRC''. 
%% The only path in the model to clinical treatment is for the patient to
%% present with symptoms. 

%% We have extended the model by incorporating a progression through the Dukes' stages.

%% \begin{itemize}
%% \item figure \ref{figure:t5.png} -- Rcpp model, no intervention, no Dukes staging.
%% This is the original CRC-Spin model where people move from adenoma to cancer with a probability
%% $$\Phi \left( \left\{ (\log( \gamma_1 (\textrm{size of adenoma})) + \gamma_2((\textrm{initiated at age}) -50))\right\}/\gamma_3 \right)$$
%% i.e. depending on the size of the adenoma and the age which the adenoma was initiated,
%% and then move to a symptomatic stage with a log-normal distribution.
%% \item figure \ref{figure:t1.png} -- S4 model, no intervention, Dukes staging. Differs in a number of details
%%   \begin{itemize}
%%   \item stage A, uniform distribution on $[1,3]$ years, probability 0.04 of symptoms
%%   \item stage B,  1 year,    probability 0.18 of symptoms
%%   \item stage  C , uniform distribution on $[1,2]$ years, probability 0.37 of symptoms,
%%   \item stage D, 1 year, probability 0.74 of symptoms,
%%   \end{itemize}
%% \item figure \ref{figure:t3.png} -- S4 model, no intervention, Dukes
%%   staging. Same as figure \ref{figure:t1.png} but with a different
%%   random starts.  Clearly a population of 50000 people, when you
%%   reduce it to males with Dukes A, is too small to produce stable
%%   estimates. See \texttt{t3.csv}
%% \item figure \ref{figure:t2.png} -- R5 model,  no intervention, Dukes staging. See \texttt{t2.csv}
%% \item figure \ref{figure:res4.png} -- R5 model,  no intervention, Dukes staging
%% \item figure \ref{figure:t7.png} -- R5 model,  NBCSP, Dukes staging
%% \end{itemize}
...
%%  \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/t5.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. (Rcpp model, no intervention, CRC-Spin.)}
%%    \label{figure:t5.png}
%%  \end{figure}
...
%% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% % %/home/dun280/Projects/clinical-genomics/simulation/script7/script11.r
%% % %model3.s -- no intervention
%% % %save(number.F,number.M,res.F,res.M,file="script11_temp_model3.Rdata")
%% \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/t1.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. Plot 1 is all CRC form the male population (approx 25000).
%%    Plot 2 is those presenting with symptoms and plot 3 is those whose
%%    cancer is asymptomatic. (S4 model, no intervention, Dukes staging)
%%  }
%%    \label{figure:t1.png}
%%  \end{figure}
...
%% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% % %/home/dun280/Projects/clinical-genomics/simulation/script7/script11.r
%% % %model3.s -- no intervention -- different random seeds
%% % %save(number.F,number.M,res.F,res.M,file="script11_temp2_model3.Rdata")
%% % % t3.csv
%% % %  ~/Projects/clinical-genomics/simulation/script7/             18713.pts-5.valkyrie	(02/26/14 20:09:34)	(Detached)  S4 Dukes
%% % % apply(res.M,2,sum)
%% % % [1] 317874  32164   9095    108   1644      0 260835  31194   7390   1644
%% % %[11]    108   4662   1372   1284    113      0    685   1641   1768    834
%% % %[21]   1853    609    222    297    791    348      0    151    370    379
%% % %[31]    191    412    141    844   2038   2180   1031   2291    758   4839
%% % %[41]   1662   2072    461    108  22998   1644      0      0      0      0
%% % %[51]      0   1644      0    211    295    790    348   1644      0      0
 
%% \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/t3.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. Plot 1 is all CRC form the male population (approx 25000).
%%    Plot 2 is those presenting with symptoms and plot 3 is those whose
%%    cancer is asymptomatic. (S4 model, no intervention, Dukes staging)}
...
%% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% % % ~/Downloads/CRC-Spin2/branches/CRC-Spin2-3tier/SpinModels/src/ 5454.pts-8.valkyrie R5 Dukes 
%% % %cc<-DukesCrcSpinModel$new(iterations=99, num_subjects=50000)
%% % % t2.csv
%%  \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/t2.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. Plot 1 is all CRC form the male population (approx 25000).
%%    Plot 2 is those presenting with symptoms and plot 3 is those whose
%%    cancer is asymptomatic. (R5 model, no intervention, Dukes
%%    staging.)}
%%    \label{figure:t2.png}
%%  \end{figure}
...
%% % %cc<-DukesCrcSpinModel$new(iterations=99, num_subjects=50000)
%% % % apply(res.M,2,sum)
%% % % [1]  557992   42962   15333     213    2585 1262545  256956   34855   11861
%% % %[10]    2585     209    7837    2264    2155     219       0     955    2669
%% % %[19]    2753    1342    3012    1130     419     540    1311     551       0
%% % %[28]     217     581     605     281     646     255    1182    3298    3403
%% % %[37]    1651    3717    1404    7654    2681    3351     760     209   21792
%% % %[46]    2585       0       0       0       0       0    2585       0     280
%% % %[55]     502    1258     545    2585       0       1
%% % %res4.Rdata 
%%  \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/res4.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. Plot 1 is all CRC form the male population (approx 25000).
%%    Plot 2 is those presenting with symptoms and plot 3 is those whose
%%    cancer is asymptomatic. (R5 model, no intervention, Dukes
%%    staging.)}
%%    \label{figure:res4.png}
%%  \end{figure}
...
%% % % code fixed 
%% % %cc<-DukesCrcSpinModel$new(iterations=99, num_subjects=50000)
%% % %#[1]  545868   36048   16212    1905    7191 1261609  254065   28616   13080                                                     
%% % %#[10]    1975    1887    6806    2034    3405    1580       0     876    3035                                                    
%% % %#[19]    3250    1647    3010    1262     326     407     994     407       0                                                    
%% % %##[28]     133     460     491     249     457     185    1130    3941    4210                                                   
%% % %#[37]    2136    3905    1620    6537    2306    4246    1966    1887   23164                                                    
%% % %#[46]    7191  113887   45402       0       0    2209    2209     834     192                                                    
%% % %#[55]      34      40       3    1103       1       0 

%%  \begin{figure}[p]
%%    \centering
%%  \includegraphics[totalheight=17cm]{./crc-spin-figs/t7.png}
%%  \caption{The CRC-spin model with a background symptomatic presentation
%%    level. Plot 1 is all CRC form the male population (approx 25000).
%%    Plot 2 is those detected by the NBCSP and plot 3 is those whose
%%    cancer is not detected. (R5 model, NBCSP, Dukes
%%    staging.)}
%%    \label{figure:t7.png}
%%  \end{figure}
...
%%   \hline
%%       & Observed   &   Estimated CR &  Estimated 2 \\
%% Adenoma prevalence &&& \\
%% \hspace{4mm} Among individuals 40-49 years old & 0.10 &  0.14  & 0.16\\
%% \hspace{4mm} Among individuals 50-75 years old & 0.22 & 0.27 &   0.27\\
%% \hspace{4mm} Among individuals 76-80 years old & 0.29 & 0.38 &  0.32\\
%% \hspace{4mm} Number of adenomas found in 1233 individuals & 534 & 575  &  \\
%% &  &   &  \\
%% Adenoma size   &&& \\
%% \hspace{4mm} Percent of individuals with an
%%   adenoma $\geq$ 10 mm, 
%% given adenoma $\geq 1$ & 0.23 & 0.28 &  \\
%% \hspace{4mm} Percent of adenomas $\leq$ 6mm                & 0.62 & 0.61 &   \\
%% \hspace{4mm} Percent of adenomas $ [6,10)  mm  $          &0.29  & 0.22  &  \\
%% \hspace{4mm} Percent of adenomas $ \geq 10 mm  $           &0.09  &0.17& 0.10 \\
%% &  &   &  \\
%% Clinical cancers in per 100,000  &&& \\
%% \hspace{4mm} Colon cancer in women  &&& \\
%% \hspace{8mm}  20-49 y.o.           & 4.8 & 4.4 & 7 \\
%% \hspace{8mm} 50-59 y.o.&43.3&45.5& 81\\
%% \hspace{8mm} 60-69 y.o.&100.7&99.3&  165\\
%% \hspace{8mm} 70-84 y.o.&216.7&207.3&  300\\
%% \hspace{4mm} Rectal cancer in women &&& \\
%% \hspace{8mm} 20-49 y.o.&1.87&2.0& 2\\
%% \hspace{8mm} 50-59 y.o.&20.4&18.6&17 \\
%% \hspace{8mm} 60-69 y.o.&42.5&39.7& 32\\
%% \hspace{8mm} 70-84 y.o.&73.9&82.1& 43 \\
%% \hspace{4mm} Colon cancer in men &&& \\
%% \hspace{8mm} 20-49 y.o.&4.51&4.2& 6\\
%% \hspace{8mm} 50-59 y.o.&45.9&50.6& 92 \\
%% \hspace{8mm} 60-69 y.o.&121.4& 120.0 &  233\\
%% \hspace{8mm} 70-84 y.o.&268.4&263.4&  405\\
%% \hspace{4mm} Rectal cancer in men &&& \\
%% \hspace{8mm} 20-49 y.o.&2.3&3.2& 4\\
%% \hspace{8mm} 50-59 y.o.&30.0&29.8&22 \\
%% \hspace{8mm} 60-69 y.o.&71.4&63.2& 43\\
%% \hspace{8mm} 70-84 y.o.&128.0&123.8&45\\
%%    \hline
%% \end{tabular}
%% \caption{comparison of observed versus predicted rates for the
%%   CRC-spin model. Based on Table 6 of
%%   \protect{\cite{Rutter.et.al.2009}}.
%% ``Estimated 2'' is our estimates with the CR posterior estimates and the S4  model.
%% }
%% \label{table:comparison.of.crc-spin}
%% \end{center}
%% \end{sidewaystable}
...
%% \begin{tabular}{||p{7cm}|l|l|l|l|l|l|l|l||}
%%   \hline
%%                                                                                              & Observed & Estimated CR & model5.s & crcSpin.R & model3.s & dukesCrcSpin.R & SpinModels\\
%% Adenoma prevalence                                                                           &          &              &          &           &          &        &       \\
%% \hspace{4mm} Among individuals 40-49 years old                                               & 0.10     & 0.14         & 0.16     & 0.15      & 0.10     & 0.15   & 0.16  \\
%% \hspace{4mm} Among individuals 50-75 years old                                               & 0.22     & 0.27         & 0.25     & 0.21      & 0.17     & 0.20   & 0.21  \\
%% \hspace{4mm} Among individuals 76-80 years old                                               & 0.29     & 0.38         & 0.23     & 0.21      & 0.21     & 0.21   & 0.21  \\
%% \hspace{4mm} Number of adenomas found in 1233 individuals                                    & 534      & 575          &          &           &          &        &       \\
%%                                                                                              &          &              &          &           &          &        &       \\
%% Adenoma size                                                                                 &          &              &          &           &          &        &       \\
%% \hspace{4mm} Percent of individuals with an   adenoma $\geq$ 10 mm    given adenoma $\geq 1$ & 0.23     & 0.28         &          &           &          &        &       \\
%% \hspace{4mm} Percent of adenomas $\leq$ 6mm                                                  & 0.62     & 0.61         &          &           &          &        &       \\
%% \hspace{4mm} Percent of adenomas $ [6,10)  mm  $                                             & 0.29     & 0.22         &          &           &          &        &       \\
%% \hspace{4mm} Percent of adenomas $ \geq 10 mm  $                                             & 0.09     & 0.17         & 0.08     & 0.12      & 0.10     & 0.10   &   0.15\\
%%                                                                                              &          &              &          &           &          &        &       \\
%% Clinical cancers in per 100,000                                                              &          &              &          &           &          &        &       \\
%% \hspace{4mm} Colon cancer in women                                                           &          &              &          &           &          &        &       \\
%% \hspace{8mm}  20-49 y.o.                                                                     & 4.8      & 4.4          & 14       &           & 15       &  36    &       \\
...
%% \hspace{8mm} 70-84 y.o.                                                                      & 128.0    & 123.8        & 91       &           & 26       &  19    &       \\   
%%                                                                                              &          &              &          &           &          &        &       \\
%% %male --CRC between 50th and 70th birthdays                                                   & 0.019    &              & 0.083    & 0.05      & 0.022    & 0.09   &  0.05 \\
%% %female --CRC between 50th and 70th birthdays                                                 & 0.014    &              & 0.064    & 0.033     & 0.011    & 0.08   &  0.03 \\           
...
cc<-CrcSpinModel$new(iterations=99, num_subjects=50)
cc$run()
cc$study_group[[12]]
