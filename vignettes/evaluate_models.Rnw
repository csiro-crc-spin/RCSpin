...
%\VignetteIndexEntry{evaluatin the models} \\
...
load("~/Dropbox/CRC-Spin2/screening_compliance/temp.RData")
...
M<-(number.M-cumsum(DukesCrcSpinModel_output$results.M$person.state.deceased))
...
#from the "data(DukesCrcSpinModel_output)"
# temp
 #               female       male
#colon 20:49   33.927160  31.373225
#colon 50:59   84.690162  85.691300
#colon 60:69  135.343709 127.390902
#colon 70:84  322.561860 257.067971
#rectal 20:49   2.800672   3.425695
#rectal 50:59   7.461132   7.463334
#rectal 60:69  12.982592  11.158925
#rectal 70:84  36.330584  23.756787
...
#  0.109
#####################################################################
#changed DukesCrCSpin 
#"treatment_record<-NBCSP(person)"  to  "treatment_record <- testForAndTreatCRC(person)"
