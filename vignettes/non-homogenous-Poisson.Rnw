...
\newsavebox\ltmcbox
\title{Non-homogeneous Poisson and Risk of Adenoma}
\author{Rob Dunne}
...
\section*{summary}
The non-homogeneous Poisson is not very different to the standard Poisson in this case. I think the problem lies elsewhere.
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/risk.png}
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/compare_simulated_poisson.png}
  ...
  \label{figure:compare_simulated_poisson.png}
\end{figure}


\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/plot3.png}
  \caption{For males  with a baseline risk of -4.4 (the most at risk group) we calculate the
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/plot4.png}
  \caption{For males  with a baseline risk of -4.4 (the most at risk group) we calculate the
  proportion initiating adenomas at each age using a standard Poisson distribution.}
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/prevalence.png}
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[totalheight=8cm]{./figs/number_of_adenomas_2.png}
...
#TT<-1 at 70
# high risk M    --   0.183 get an adenoma in their 70th year
# medium risk M  -- 0.022 get an adenoma in their 70th year
# low risk M     --  0.002 get an adenoma in their 70th year
...
png("./figs/compare_simulated_poisson.png")
