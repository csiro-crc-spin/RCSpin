...
\begin{tabular}{||l|l|l||}
 ...
 & female & male \\ 
  \hline
colon 20:49 & 36.22 & 33.57 \\ 
  colon 50:59 & 87.88 & 92.31 \\ 
  colon 60:69 & 113.36 & 109.50 \\ 
  colon 70:84 & 247.25 & 236.62 \\ 
  rectal 20:49 & 2.85 & 3.69 \\ 
  rectal 50:59 & 9.66 & 6.85 \\ 
  rectal 60:69 & 10.29 & 11.80 \\ 
  rectal 70:84 & 29.16 & 19.89 \\ 
   \hline
\end{tabular}
\caption{The male and female age rates for colon and rectal cancer.} 
\label{table:age.rates}
...
svn export CRC-Spin2-R5-package test1
git config --global user.email "rob.dunne@csiro.au"
git config --global user.name "dun280"
cd test1
git init
git add .
git remote add origin https://github.com/parsifal9/test1.git
git push origin master
git pull https://github.com/parsifal9/test1.git/  #there is a README.md file on https://github.com/parsifal9/test1 that has to be pulled down first
...
dd$run()
help(RCSpin)
#No documentation for ‘RCSpin’ in specified packages and libraries:
#you could try ‘??RCSpin’
