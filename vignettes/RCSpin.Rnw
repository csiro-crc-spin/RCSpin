...
\begin{figure}[tbhp]
  ...
  \caption{A population of 1000 people subjected to the mortality rates of a supplied table.}
...
\begin{figure}[tbhp]
  ...
  \caption{A population of 5000 people subjected to the CRC-SPIN model.}
...
unix.time(cc<-CrcSpinModel$new(iterations=99, num_subjects=50000,base_seed=122))
unix.time(cc$run())
object.size(cc)
cc$study_group[[12]]
...
#Women colon cancer
mean(apply(results.F[20:49,28:32],1,sum)/((number.F-cumsum(results.F[,45]))[20:49]))*100000
mean(apply(results.F[50:59,28:32],1,sum)/((number.F-cumsum(results.F[,45]))[50:59]))*100000
mean(apply(results.F[60:69,28:32],1,sum)/((number.F-cumsum(results.F[,45]))[60:69]))*100000
mean(apply(results.F[70:84,28:32],1,sum)/((number.F-cumsum(results.F[,45]))[70:84]))*100000

#Male colon cancer
mean(apply(results.M[20:49,28:32],1,sum)/((number.M-cumsum(results.M[,45]))[20:49]))*100000
mean(apply(results.M[50:59,28:32],1,sum)/((number.M-cumsum(results.M[,45]))[50:59]))*100000
mean(apply(results.M[60:69,28:32],1,sum)/((number.M-cumsum(results.M[,45]))[60:69]))*100000
mean(apply(results.M[70:84,28:32],1,sum)/((number.M-cumsum(results.M[,45]))[70:84]))*100000


#Women rectal cancer
mean(results.F[20:49,33]/((number.F-cumsum(results.F[,45]))[20:49]))*100000
mean(results.F[50:59,33]/((number.F-cumsum(results.F[,45]))[50:59]))*100000
mean(results.F[60:69,33]/((number.F-cumsum(results.F[,45]))[60:69]))*100000
mean(results.F[70:84,33]/((number.F-cumsum(results.F[,45]))[70:84]))*100000

#Male rectal cancer
mean(results.M[20:49,33]/((number.M-cumsum(results.M[,45]))[20:49]))*100000
mean(results.M[50:59,33]/((number.M-cumsum(results.M[,45]))[50:59]))*100000
mean(results.M[60:69,33]/((number.M-cumsum(results.M[,45]))[60:69]))*100000
mean(results.M[70:84,33]/((number.M-cumsum(results.M[,45]))[70:84]))*100000
...
\begin{figure}[p]
  ...
  \caption{Stacked plots \protect{\cite[]{menugget.2013}} of the distribution of CRC by Dukes' stages across a range of ages for a male population of size 25000.}
